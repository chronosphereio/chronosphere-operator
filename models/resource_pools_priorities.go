...
type ResourcePoolsPriorities struct {
	...
	HighPriorityFilters []*Configv1LabelFilter `json:"high_priority_filters,omitempty"`
	...
	LowPriorityFilters []*Configv1LabelFilter `json:"low_priority_filters,omitempty"`
}
